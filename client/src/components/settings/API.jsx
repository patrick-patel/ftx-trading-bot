    ...
    if (deletedAPI) {
      ...
      return (
        <div className="mb-2 bg-dark pt-2 ps-4 pe-4">
          ...
          {this.state.edit ? <Button className="btn-secondary me-2" style={{cursor: "pointer"}} onClick={this.onEdit.bind(this)}>Cancel Edit</Button> : <Button className="btn-primary me-2" style={{cursor: "pointer"}} onClick={this.onEdit.bind(this)}>Edit Pairs</Button>}
