  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.state.edit ? <Button className="btn-secondary me-2" onClick={this.onEdit.bind(this)}>Cancel Edit</Button> : <Button onClick={this.onEdit.bind(this)}>Edit Pairs</Button>}
