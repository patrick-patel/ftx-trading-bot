    ...
    <div>
      ...
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          ...
          <Button onClick={() => props.onPairChange("LINK/BTC", "6hr")} active={props.state["LINK/BTC"] === "6hr"}>LINK/BTC 6hr</Button>
          <Button onClick={() => props.onPairChange("LINK/BTC", "12hr")} active={props.state["LINK/BTC"] === "12hr"}>LINK/BTC 12hr</Button>
        </ButtonGroup>
      </Row>
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          <Button onClick={() => props.onPairChange("LINK/USD", "1hr")} active={props.state["LINK/USD"] === "1hr"}>LINK/USD 1hr</Button>
          <Button onClick={() => props.onPairChange("LINK/USD", "2hr")} active={props.state["LINK/USD"] === "2hr"}>LINK/USD 2hr</Button>
          <Button onClick={() => props.onPairChange("LINK/USD", "4hr")} active={props.state["LINK/USD"] === "4hr"}>LINK/USD 4hr</Button>
          <Button onClick={() => props.onPairChange("LINK/USD", "6hr")} active={props.state["LINK/USD"] === "6hr"}>LINK/USD 6hr</Button>
          <Button onClick={() => props.onPairChange("LINK/USD", "12hr")} active={props.state["LINK/USD"] === "12hr"}>LINK/USD 12hr</Button>
        </ButtonGroup>
      </Row>
    </div>
    ...
    <div>
      ...
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          ...
          <Button onClick={() => props.onPairChange("MATIC/BTC", "6hr")} active={props.state["MATIC/BTC"] === "6hr"}>MATIC/BTC 6hr</Button>
          <Button onClick={() => props.onPairChange("MATIC/BTC", "12hr")} active={props.state["MATIC/BTC"] === "12hr"}>MATIC/BTC 12hr</Button>\
        </ButtonGroup>
      </Row>
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          <Button onClick={() => props.onPairChange("MATIC/USD", "1hr")} active={props.state["MATIC/USD"] === "1hr"}>MATIC/USD 1hr</Button>
          <Button onClick={() => props.onPairChange("MATIC/USD", "2hr")} active={props.state["MATIC/USD"] === "2hr"}>MATIC/USD 2hr</Button>
          <Button onClick={() => props.onPairChange("MATIC/USD", "4hr")} active={props.state["MATIC/USD"] === "4hr"}>MATIC/USD 4hr</Button>
          <Button onClick={() => props.onPairChange("MATIC/USD", "6hr")} active={props.state["MATIC/USD"] === "6hr"}>MATIC/USD 6hr</Button>
          <Button onClick={() => props.onPairChange("MATIC/USD", "12hr")} active={props.state["MATIC/USD"] === "12hr"}>MATIC/USD 12hr</Button>
        </ButtonGroup>
      </Row>
    </div>
    ...
    <div>
      ...
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          ...
          <Button onClick={() => props.onPairChange("SOL/BTC", "6hr")} active={props.state["SOL/BTC"] === "6hr"}>SOL/BTC 6hr</Button>
          <Button onClick={() => props.onPairChange("SOL/BTC", "12hr")} active={props.state["SOL/BTC"] === "12hr"}>SOL/BTC 12hr</Button>
        </ButtonGroup>
      </Row>
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          <Button onClick={() => props.onPairChange("SOL/USD", "1hr")} active={props.state["SOL/USD"] === "1hr"}>SOL/USD 1hr</Button>
          <Button onClick={() => props.onPairChange("SOL/USD", "2hr")} active={props.state["SOL/USD"] === "2hr"}>SOL/USD 2hr</Button>
          <Button onClick={() => props.onPairChange("SOL/USD", "4hr")} active={props.state["SOL/USD"] === "4hr"}>SOL/USD 4hr</Button>
          <Button onClick={() => props.onPairChange("SOL/USD", "6hr")} active={props.state["SOL/USD"] === "6hr"}>SOL/USD 6hr</Button>
          <Button onClick={() => props.onPairChange("SOL/USD", "12hr")} active={props.state["SOL/USD"] === "12hr"}>SOL/USD 12hr</Button>
        </ButtonGroup>
      </Row>
    </div>
    ...
    <div>
      ...
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          ...
          <Button onClick={() => props.onPairChange("UNI/BTC", "6hr")} active={props.state["UNI/BTC"] === "6hr"}>UNI/BTC 6hr</Button>
          <Button onClick={() => props.onPairChange("UNI/BTC", "12hr")} active={props.state["UNI/BTC"] === "12hr"}>UNI/BTC 12hr</Button>
        </ButtonGroup>
      </Row>
      <Row>
        <ButtonGroup className="mb-2" size="sm">
          <Button onClick={() => props.onPairChange("UNI/USD", "1hr")} active={props.state["UNI/USD"] === "1hr"}>UNI/USD 1hr</Button>
          <Button onClick={() => props.onPairChange("UNI/USD", "2hr")} active={props.state["UNI/USD"] === "2hr"}>UNI/USD 2hr</Button>
          <Button onClick={() => props.onPairChange("UNI/USD", "4hr")} active={props.state["UNI/USD"] === "4hr"}>UNI/USD 4hr</Button>
          <Button onClick={() => props.onPairChange("UNI/USD", "6hr")} active={props.state["UNI/USD"] === "6hr"}>UNI/USD 6hr</Button>
          <Button onClick={() => props.onPairChange("UNI/USD", "12hr")} active={props.state["UNI/USD"] === "12hr"}>UNI/USD 12hr</Button>
        </ButtonGroup>
      </Row>
    </div>
    <Button className="mb-2 mt-2" type="submit" style={cursor: "pointer"} onSubmit={props.submitPairs}>Submit</Button>
  </div>
